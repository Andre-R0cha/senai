    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_sobre, container, false);
        return new AboutPage(getActivity())
                ...
                .addFacebook("acesso face", "Facebook")
                .addEmail("acesso Email","Email")
                .addGitHub("acesso GitHub","Git")
                .addInstagram("acesso Instagram", "Instagram")
                .addTwitter("acesso Twitter", "Twitter")
                .addYoutube("acesso Youtube","Youtube")
                .addPlayStore("play story","PlayStrore")
                .create();
