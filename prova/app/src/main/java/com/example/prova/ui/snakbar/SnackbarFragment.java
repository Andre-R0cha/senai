package com.example.prova.ui.snakbar;
...
public class SnackbarFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        testeSnack =  view.findViewById(R.id.testeSnack);
       testeSnack.setOnClickListener(this);
        return view;
    }
    ...
    public void onClick(View v) {
        ...
        Snackbar.make(v, "Liberdade de dizer nao.", Snackbar.LENGTH_INDEFINITE).
                setAction("texto", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
